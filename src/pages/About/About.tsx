    ...
    <ThemeProvider theme={theme}>
        <Container maxWidth={false}>
            <Box component={Paper} sx={{border: '2px solid #27163c', textAlign: 'left', mt: 2 }}>
                ...
                <Typography sx={{ mt: 4, mb: 1, ml: 5, mr: 5 }} variant="body1" component="p">
                That's where OrbitalEye comes in. With our DAO, users can submit NEO data and get paid in $METEORite. This data is then voted on by our members, and the most valuable information is sent to the NASA JPL Asteroid Team to help with their research.
